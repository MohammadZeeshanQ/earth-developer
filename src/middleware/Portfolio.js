...
import ArabNewsApp from "../assets/images/projects/arabNewsApp.png";
...
export const WebAppProject = [
	{
		title: "Arab News Covid",
		image: ArabNewsApp,
		link: "https://arabnews-covid19-theme-with-api.netlify.app/",
		description: "Web App developed to retrieve Covid-19 cases information and country cases",
		program: [{ code: "Next.js" }, { code: "Styled-component" }],
	},
	{
		title: "Covid Vision",
		image: covidWeb,
	...
	},
	{
		...
		description: "Random mixed genre jokes generated through an API call limited to 2 jokes",
	...
	},
	{
		...
		description: "Web App that retrieve data from Pokemon API and its information with details",
		program: [{ code: "React.js" }, { code: "Material-Ui" }],
	},
	{
		title: "Weather App",
		...
		description: "A weather App built using API calling functions with 2 days predictions",
